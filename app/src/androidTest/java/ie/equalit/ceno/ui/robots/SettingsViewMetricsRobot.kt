...
private fun crashReportingButton() = onView(
    allOf(
        withId(R.id.campaignCrashReporting),
        hasDescendant(withText(R.string.preferences_allow_crash_reporting))
    )
)

private fun metricsButton() = onView(
    allOf(
        withId(R.id.campaignOuinetMetrics),
        hasDescendant(withText(R.string.metrics_ouinet_title))
    )
)

private fun metricsHeading() =
    onView(withText(R.string.clean_insights_header))

private fun metricsSubHeading() =
    onView(withText(R.string.clean_insights_sub_header))

private fun metricsOptionalMetrics() =
    onView(withText(R.string.optional_metrics))

private fun metricsToggle1() = onView(withText(R.string.device_type))
private fun metricsToggle2() = onView(withText(R.string.device_locale))
private fun metricsExplainer() =
    onView(withText(R.string.clean_insights_explainer))

private fun metricsLearnMore() = onView(withText(R.string.learn_more_title))
private fun metricsNegativeButton() =
    onView(withText(R.string.clean_insights_maybe_later))

private fun metricsPositiveButton() =
    onView(withText(R.string.clean_insights_opt_in))
