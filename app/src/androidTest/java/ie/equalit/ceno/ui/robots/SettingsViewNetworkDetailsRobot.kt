...
private fun localProxyEndpointDisplay() =
    Espresso.onView(ViewMatchers.withText(R.string.preferences_ouinet_proxy_endpoint))
...
private fun externalUdpEndpointsDisplay() =
    Espresso.onView(ViewMatchers.withText(R.string.preferences_ceno_sources_external_udp))

private fun publicUdpEndpointsDisplay() =
    Espresso.onView(ViewMatchers.withText(R.string.preferences_ceno_sources_public_udp))

private fun bridgeModeHeading() =
    Espresso.onView(ViewMatchers.withText(R.string.bridge_mode_category))

private fun btBootstrapsHeading() =
    Espresso.onView(ViewMatchers.withText(R.string.bit_torrent_bootstraps_category))

private fun extraBtBootstrapsButton() =
    Espresso.onView(ViewMatchers.withText(R.string.preferences_ceno_sources_extra_bitTorrent_bootstraps))
