...
object FailedToRetrieveResource {
    ...
    fun createErrorPage(
        ...
        return context.resources.openRawResource(R.raw.server500)
            ...
            .replace(
                "%body_theme%",
                getHexColor(ContextCompat.getColor(context, R.color.fx_mobile_layer_color_2))
            )
            .replace(
                "%text_theme%",
                getHexColor(ContextCompat.getColor(context, R.color.fx_mobile_text_color_primary))
            )
            .replace(
                "%logo_theme%",
                getHexColor(ContextCompat.getColor(context, R.color.logo_text_color))
            )
