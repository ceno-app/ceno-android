...
- Bug setting custom BitTorrent bootstraps via dialog

## [v2.11.6](https://gitlab.com/ceno-app/ceno-android/-/releases/v2.11.6) - 2026-09-24
...
- Unable to add shortcuts to homepage in previous release

## [v2.11.0](https://gitlab.com/ceno-app/ceno-android/-/releases/v2.11.0) - 2026-07-28
